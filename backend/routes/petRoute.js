...
router.patch("/mine/:id/images", auth, upload.array("images", 3), patchPetImages); // this is for uploading images only
router.patch("/mine/:id", auth, upload.array("images", 3), patchPet); // this is for modifying data + image upload
