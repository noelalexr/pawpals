...
export default function DeveloperDashboard() {
    ...
    return (
        <div style={styles.container} className="md:h-screen overflow-hidden flex justify-center items-center bg-cover bg-center bg-no-repeat font-sans md:p-2 ">
            <div className="md:flex md:flex-row md:rounded-lg shadow-lg md:max-h-[90vh] md:w-[95%] md:h-[95%] bg-white/95 p-6 gap-4">
                <div style={styles.sidebar} className="md:w-[40%] overflow-auto pr-1">
                    <div className="md:flex justify-center items-center mb-1">
                        ...
                        <div style={{ display: "flex", gap: "0.5rem", alignItems: "center", whiteSpace: "nowrap" }}>
                            <button style={styles.registerButton} onClick={() => navigate("/dev-dashboard/signup")}>
                                Register Dev
                            </button>
                ...
                <div style={styles.detailsPanel} className="md:w-[60%] md:overflow-y-auto">
                    {selected ? (
                        <div>
