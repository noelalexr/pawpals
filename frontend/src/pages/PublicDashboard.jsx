    ...
    return (
        <div className='min-h-screen bg-gradient-to-b from-gray-50 to-gray-200 bg-fixed'>
            ...
            <div className="flex flex-col md:mx-[18%] mx-5 mt-3">
                ...
                <select
                    className="px-3 py-1 rounded-lg appearance-none focus:outline-none focus:bg-[#d7e3f4] hover:bg-[#d7e3f4] cursor-pointer transition-colors duration-300 text-xl"
                    value={selectedCity}
                    onChange={(e) => {
            ...
            <div className="py-2 md:px-[12vw] mb-3 text-center">
                ...
                <div className="flex gap-2 justify-center mt-3">
                    ...
                    <select
                        className="p-2 rounded-lg appearance-none focus:outline-none my-auto text-gray-600 text-sm focus:bg-[#c2d4ee] hover:bg-[#c2d4ee] cursor-pointer transition-colors duration-300 text-center bg-[#d7e3f4]"
